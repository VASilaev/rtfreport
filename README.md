...
5. `{f(<Выражение>)}` Выводит выражение в отчете
...
ean13||Текст_с_штрихкодом; Ширина; Высота|Rtf блок|Вставляет в документ картинку с штрихкодом в формате EAN13. Штрих код должен быть не больше 13 цыфр, при этом крайняя правая цифра - это контрольная сумма
code128||Текст; Ширина; Высота|Rtf блок|Вставляет в документ картинку с штрихкодом в формате CODE128. Штрих код должен состоять только из букв английского алфавита и цыфр. Контрольное число добавляется автоматически в конец.
